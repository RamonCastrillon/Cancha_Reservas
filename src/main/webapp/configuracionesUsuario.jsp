                        ...
                        <div class="col-xl-9 custom-col-xl-9 col-lg-10 mx-auto">
                            <div class="bg-faded rounded p-5">
                                ...
                                <div class="text-center">
                                    ...
                                    <form action="SvActualizarInfoUsuario" method="POST">
                                        ...
                                        <%
                                            OperacionesPersona opPerson = new OperacionesPersona(OperacionesBaseDatos.conectar());
                                        ...
                                        %>
                                        <p><label>Número de celular (Actual: <%=person.getNumeroCelular()%>) </label>
                                            <input type="text" name="celular" size="15" class="form-control">
                                        </p>
                                        <p><label>Correo electronico (Actual: <%=person.getCorreoElectronico()%>) </label>
                                    ...
                                    <form action="hacerReserva.jsp" style="margin-top: 15px">
